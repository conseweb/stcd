...
const (
	...
	baseSubsidy = 50 * coinutil.SatoshiPerBitcoin
...
// CheckBlockSanity performs some preliminary checks on a block to ensure it is
// sane before continuing with block processing.  These checks are context free.
func CheckBlockSanity(block *coinutil.Block, powLimit *big.Int, timeSource MedianTimeSource) error {
...
func checkSerializedHeight(coinbaseTx *coinutil.Tx, wantHeight int32) error {
