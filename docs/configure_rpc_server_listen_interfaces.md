...
|--rpclisten=:6684|all interfaces on port 6684|
|--rpclisten=0.0.0.0:6684|all IPv4 interfaces on port 6684|
|--rpclisten=[::]:6684|all IPv6 interfaces on port 6684|
|--rpclisten=127.0.0.1:6684|only IPv4 localhost on port 6684|
|--rpclisten=[::1]:6684|only IPv6 localhost on port 6684|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:6684|IPv4 localhost on port 8337 and IPv6 localhost on port 6684|
|--rpclisten=:6684 --listen=:8337|all interfaces on ports 6684 and 8337|
