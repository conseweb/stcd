...
(http://godoc.org/github.com/conseweb/stcd/peer)
...
```bash
$ go get -u github.com/conseweb/stcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/conseweb/stcd/peer#example-package--NewOutboundPeer)  
